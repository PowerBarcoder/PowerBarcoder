...
Rscript "${workingDirectory}dada2_denoise_PE_newprimer.r" "$ampliconInfo" "$workingDirectory" "$resultDataPath" "$dada2LearnErrorFile" "$dada2BarcodeFile" "${nameOfLoci[@]}" "${primerFName[@]}" "${primerRName[@]}"
